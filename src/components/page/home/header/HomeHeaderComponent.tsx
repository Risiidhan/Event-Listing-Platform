...
const HomeHeaderComponent = () => {
    return (
        <div className="relative w-full min-h-[40dvh] flex flex-col items-center">
            ...
            <div className="font-bold content-section text-white w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center p-4 flex flex-col items-center gap-2">
